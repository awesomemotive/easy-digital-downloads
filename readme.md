...
![Download products overview](http://s.wordpress.org/extend/plugins/easy-digital-downloads/screenshot-1.png)

###2. Download configuration###
![Download configuration](http://s.wordpress.org/extend/plugins/easy-digital-downloads/screenshot-2.png)

###3. Download configuration details###
![Download configuration details](http://s.wordpress.org/extend/plugins/easy-digital-downloads/screenshot-3.png)

###4. Download configuration with variable prices###
![Download configuration with variable prices](http://s.wordpress.org/extend/plugins/easy-digital-downloads/screenshot-4.png)

###5. Payment history###
![Payment history](http://s.wordpress.org/extend/plugins/easy-digital-downloads/screenshot-5.png)

###6. Discount codes###
![Discount codes](http://s.wordpress.org/extend/plugins/easy-digital-downloads/screenshot-6.png)

###7. Earnings and sales reports###
![Earnings and sales reports](http://s.wordpress.org/extend/plugins/easy-digital-downloads/screenshot-7.png)

###8. Add to cart / purchase button###
![Add to cart / purchase button](http://s.wordpress.org/extend/plugins/easy-digital-downloads/screenshot-8.png)

###9. Checkout screen###
![Checkout screen](http://s.wordpress.org/extend/plugins/easy-digital-downloads/screenshot-9.png)
