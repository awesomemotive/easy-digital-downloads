...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
    ...
    /**
     * This option allow you to opt-in for the EDD\Vendor\Carbon 3 behavior where float
     ...
     * code including the third-party dependencies that also may use EDD\Vendor\Carbon will
