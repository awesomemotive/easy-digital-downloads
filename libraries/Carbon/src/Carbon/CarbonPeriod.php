...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param CarbonPeriod|\DateTimeInterface|EDD\Vendor\Carbon|CarbonImmutable|string $rangeOrRangeStart
     * @param \DateTimeInterface|EDD\Vendor\Carbon|CarbonImmutable|string|null         $rangeEnd
     *
     * @return bool
     */
     ...
     * @example
     * ```
     * Carbon::create('2020-11-29')->daysUntil('2020-12-24')->forEach(function (EDD\Vendor\Carbon $date) {
     ...
     * echo implode("\n", iterator_to_array($period->map(function (EDD\Vendor\Carbon $date) {
    ...
    /**
     * Return the EDD\Vendor\Carbon instance passed through, a now instance in the same timezone
