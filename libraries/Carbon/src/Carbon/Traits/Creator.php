 ...
 *
 * @method static EDD\Vendor\Carbon|CarbonImmutable getTestNow()
 */
trait Creator
{
    ...
    /**
     * Create a new EDD\Vendor\Carbon instance.
     *
    ...
    /**
     * Create a EDD\Vendor\Carbon instance from a DateTime one.
     *
     * @param DateTimeInterface $date
     *
     * @return static
    ...
    /**
     * Create a EDD\Vendor\Carbon instance for today.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a EDD\Vendor\Carbon instance for tomorrow.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a EDD\Vendor\Carbon instance for yesterday.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a EDD\Vendor\Carbon instance for the greatest supported date.
     *
     * @return static
     */
    ...
    /**
     * Create a EDD\Vendor\Carbon instance for the lowest supported date.
     *
     * @return static
     */
    ...
    /**
     * Create a new EDD\Vendor\Carbon instance from a specific date and time.
     *
    ...
    /**
     * Create a new safe EDD\Vendor\Carbon instance from a specific date and time.
     *
     * If any of $year, $month or $day are set to null their now() values will
     * be used.
     *
    ...
    /**
     * Create a new EDD\Vendor\Carbon instance from a specific date and time using strict validation.
     *
     * @see create()
     *
     * @param int|null                 $year
    ...
    /**
     * Create a EDD\Vendor\Carbon instance from just a date. The time portion is set to now.
     *
     * @param int|null                 $year
     * @param int|null                 $month
     * @param int|null                 $day
    ...
    /**
     * Create a EDD\Vendor\Carbon instance from just a date. The time portion is set to midnight.
     *
     * @param int|null                 $year
     * @param int|null                 $month
     * @param int|null                 $day
    ...
    /**
     * Create a EDD\Vendor\Carbon instance from just a time. The date portion is set to today.
     *
     * @param int|null                 $hour
     * @param int|null                 $minute
     * @param int|null                 $second
    ...
    /**
     * Create a EDD\Vendor\Carbon instance from a time string. The date portion is set to today.
     *
     * @param string                   $time
     * @param DateTimeZone|string|null $tz
     *
    ...
    /**
     * Create a EDD\Vendor\Carbon instance from a specific format.
     *
     * @param string                         $format Datetime format
     * @param string                         $time
    ...
    /**
     * Create a EDD\Vendor\Carbon instance from a specific ISO format (same replacements as ->isoFormat()).
     *
     * @param string                                             $format     Datetime format
     * @param string                                             $time
    ...
    /**
     * Create a EDD\Vendor\Carbon instance from a specific format and a string in a given language.
     *
     * @param string                         $format Datetime format
     * @param string                         $locale
     * @param string                         $time
    ...
    /**
     * Create a EDD\Vendor\Carbon instance from a specific ISO format and a string in a given language.
     *
    ...
    /**
     * Make a EDD\Vendor\Carbon instance from given variable if possible.
     *
