...
trait Difference
{
    ...
    public function floatDiffInMonths($date = null, $absolute = true)
    {
        ...
        /** @var EDD\Vendor\Carbon|CarbonImmutable $floorEnd */
        ...
        /** @var EDD\Vendor\Carbon|CarbonImmutable $startOfMonthAfterFloorEnd */
    ...
    public function floatDiffInYears($date = null, $absolute = true)
    {
        ...
        /** @var EDD\Vendor\Carbon|CarbonImmutable $startOfYearAfterFloorEnd */
     ...
     * ```
     *
     * @param EDD\Vendor\Carbon|\DateTimeInterface|string|array|null $other   if array passed, will be used as parameters array, see $syntax below;
     ...
     *
     * @param EDD\Vendor\Carbon|\DateTimeInterface|string|null $referenceTime
     * @param array                                 $formats
     *
     * @return string
     */
