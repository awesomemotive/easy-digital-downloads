...
/**
 * A factory to generate EDD\Vendor\Carbon instances with common settings.
 *
 ...
 *                                                                                                                                                                                         new instance.
 * @method EDD\Vendor\Carbon|false                                       create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)                                     Create a new EDD\Vendor\Carbon instance from a specific date and time.
 ...
 *                                                                                                                                                                                         will be 0.
 * @method EDD\Vendor\Carbon                                             createFromDate($year = null, $month = null, $day = null, $tz = null)                                                         Create a EDD\Vendor\Carbon instance from just a date. The time portion is set to now.
 * @method EDD\Vendor\Carbon|false                                       createFromFormat($format, $time, $tz = null)                                                                                 Create a EDD\Vendor\Carbon instance from a specific format.
 * @method EDD\Vendor\Carbon|false                                       createFromIsoFormat($format, $time, $tz = null, $locale = 'en', $translator = null)                                          Create a EDD\Vendor\Carbon instance from a specific ISO format (same replacements as ->isoFormat()).
 * @method EDD\Vendor\Carbon|false                                       createFromLocaleFormat($format, $locale, $time, $tz = null)                                                                  Create a EDD\Vendor\Carbon instance from a specific format and a string in a given language.
 * @method EDD\Vendor\Carbon|false                                       createFromLocaleIsoFormat($format, $locale, $time, $tz = null)                                                               Create a EDD\Vendor\Carbon instance from a specific ISO format and a string in a given language.
 * @method EDD\Vendor\Carbon                                             createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)                                                              Create a EDD\Vendor\Carbon instance from just a time. The date portion is set to today.
 * @method EDD\Vendor\Carbon                                             createFromTimeString($time, $tz = null)                                                                                      Create a EDD\Vendor\Carbon instance from a time string. The date portion is set to today.
 * @method EDD\Vendor\Carbon                                             createFromTimestamp($timestamp, $tz = null)                                                                                  Create a EDD\Vendor\Carbon instance from a timestamp and set the timezone (use default one if not specified).
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method EDD\Vendor\Carbon                                             createFromTimestampMs($timestamp, $tz = null)                                                                                Create a EDD\Vendor\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method EDD\Vendor\Carbon                                             createFromTimestampMsUTC($timestamp)                                                                                         Create a EDD\Vendor\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method EDD\Vendor\Carbon                                             createFromTimestampUTC($timestamp)                                                                                           Create a EDD\Vendor\Carbon instance from an timestamp keeping the timezone to UTC.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method EDD\Vendor\Carbon                                             createMidnightDate($year = null, $month = null, $day = null, $tz = null)                                                     Create a EDD\Vendor\Carbon instance from just a date. The time portion is set to midnight.
 * @method EDD\Vendor\Carbon|false                                       createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)               Create a new safe EDD\Vendor\Carbon instance from a specific date and time.
 *                                                                                                                                                                                         If any of $year, $month or $day are set to null their now() values will
 *                                                                                                                                                                                         be used.
 *                                                                                                                                                                                         If $hour is null it will be set to its now() value and the default
 *                                                                                                                                                                                         values for $minute and $second will be their now() values.
 ...
 * @method EDD\Vendor\Carbon                                             disableHumanDiffOption($humanDiffOption)                                                                                     @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 * @method EDD\Vendor\Carbon                                             enableHumanDiffOption($humanDiffOption)                                                                                      @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 * @method EDD\Vendor\Carbon                                             fromSerialized($value)                                                                                                       Create an instance from a serialized string.
 ...
 * @method Closure|EDD\Vendor\Carbon                                     getTestNow()                                                                                                                 Get the EDD\Vendor\Carbon instance (real or mock) to be returned when a "now"
 *                                                                                                                                                                                         instance is created.
 ...
 * @method EDD\Vendor\Carbon                                             instance($date)                                                                                                              Create a EDD\Vendor\Carbon instance from a DateTime one.
 ...
 * @method EDD\Vendor\Carbon|null                                        make($var)                                                                                                                   Make a EDD\Vendor\Carbon instance from given variable if possible.
 *                                                                                                                                                                                         Always return a new instance. Parse only strings and only these likely to be dates (skip intervals
 *                                                                                                                                                                                         and recurrences). Throw an exception for invalid format, but otherwise return null.
 * @method EDD\Vendor\Carbon                                             maxValue()                                                                                                                   Create a EDD\Vendor\Carbon instance for the greatest supported date.
 * @method EDD\Vendor\Carbon                                             minValue()                                                                                                                   Create a EDD\Vendor\Carbon instance for the lowest supported date.
 * @method void                                               mixin($mixin)                                                                                                                Mix another object into the class.
 * @method EDD\Vendor\Carbon                                             now($tz = null)                                                                                                              Get a EDD\Vendor\Carbon instance for the current date and time.
 * @method EDD\Vendor\Carbon                                             parse($time = null, $tz = null)                                                                                              Create a carbon instance from a string.
 *                                                                                                                                                                                         This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                                         as it allows you to do Carbon::parse('Monday next week')->fn() rather
 *                                                                                                                                                                                         than (new Carbon('Monday next week'))->fn().
 * @method EDD\Vendor\Carbon                                             parseFromLocale($time, $locale = null, $tz = null)                                                                           Create a carbon instance from a localized string (in French, Japanese, Arabic, etc.).
 * @method string                                             pluralUnit(string $unit)                                                                                                     Returns standardized plural of a given singular/plural unit name (in English).
 * @method EDD\Vendor\Carbon|false                                       rawCreateFromFormat($format, $time, $tz = null)                                                                              Create a EDD\Vendor\Carbon instance from a specific format.
 * @method EDD\Vendor\Carbon                                             rawParse($time = null, $tz = null)                                                                                           Create a carbon instance from a string.
 *                                                                                                                                                                                         This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                                         as it allows you to do Carbon::parse('Monday next week')->fn() rather
 *                                                                                                                                                                                         than (new Carbon('Monday next week'))->fn().
 * @method EDD\Vendor\Carbon                                             resetMacros()                                                                                                                Remove all macros and generic macros.
 ...
 * @method EDD\Vendor\Carbon                                             setFallbackLocale($locale)                                                                                                   Set the fallback locale.
 * @method EDD\Vendor\Carbon                                             setHumanDiffOptions($humanDiffOptions)                                                                                       @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 * @method EDD\Vendor\Carbon                                             setTestNow($testNow = null)                                                                                                  Set a EDD\Vendor\Carbon instance (real or mock) to be returned when a "now"
 ...
 * @method EDD\Vendor\Carbon                                             setTestNowAndTimezone($testNow = null, $tz = null)                                                                           Set a EDD\Vendor\Carbon instance (real or mock) to be returned when a "now"
 *                                                                                                                                                                                         instance is created.  The provided instance will be returned
 *                                                                                                                                                                                         specifically under the following conditions:
 *                                                                                                                                                                                           - A call to the static now() method, ex. Carbon::now()
 *                                                                                                                                                                                           - When a null (or blank string) is passed to the constructor or parse(), ex. new Carbon(null)
 ...
 * @method EDD\Vendor\Carbon                                             setUtf8($utf8)                                                                                                               @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 ...
 * @method EDD\Vendor\Carbon                                             today($tz = null)                                                                                                            Create a EDD\Vendor\Carbon instance for today.
 * @method EDD\Vendor\Carbon                                             tomorrow($tz = null)                                                                                                         Create a EDD\Vendor\Carbon instance for tomorrow.
 ...
 *                                                                                                                                                                                                     Or you can use method variants: addMonthsWithOverflow/addMonthsNoOverflow, same variants
 *                                                                                                                                                                                                     are available for quarters, years, decade, centuries, millennia (singular and plural forms).
 * @method EDD\Vendor\Carbon                                             useStrictMode($strictModeEnabled = true)                                                                                     @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 *                                                                                                                                                                                         /!\ Use this method for unit tests only.
 * @method EDD\Vendor\Carbon                                             yesterday($tz = null)                                                                                                        Create a EDD\Vendor\Carbon instance for yesterday.
 *
 * </autodoc>
 */
class Factory
