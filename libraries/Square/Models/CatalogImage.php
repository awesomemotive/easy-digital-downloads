...
class CatalogImage implements \JsonSerializable
{
    ...
    /**
     * Returns Name.
     * The internal name to identify this image in calls to the EDD\Vendor\Square API.
    ...
    /**
     * Returns Url.
     * The URL of this image, generated by EDD\Vendor\Square after an image is uploaded
     ...
     * EDD\Vendor\Square Online Store. This is a searchable attribute for use in applicable query filters
     * using the [SearchCatalogObjects](api-endpoint:Catalog-SearchCatalogObjects).
     */
     ...
     * The immutable order ID for this image object created by the Photo Studio service in EDD\Vendor\Square Online
     * Store.
     */
