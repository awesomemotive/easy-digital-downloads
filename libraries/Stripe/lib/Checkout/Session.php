 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Only present on Sessions in <code>payment</code> or <code>subscription</code> mode.
 ...
 * @property \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|string|\EDD\Vendor\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\EDD\Vendor\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\EDD\Vendor\Stripe\StripeObject $shipping Shipping information for this Checkout Session.
 ...
 * @property null|string|\EDD\Vendor\Stripe\ShippingRate $shipping_rate The ID of the ShippingRate for Checkout Sessions in <code>payment</code> mode.
...
class Session extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\LineItem> the list of items
     */
