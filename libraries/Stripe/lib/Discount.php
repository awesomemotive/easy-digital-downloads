 ...
 * @property \EDD\Vendor\Stripe\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\EDD\Vendor\Stripe\Customer $customer The ID of the customer associated with this discount.
