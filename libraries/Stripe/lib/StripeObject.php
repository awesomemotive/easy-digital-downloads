...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function &__get($k)
    {
        ...
        if (!empty($this->_transientValues) && $this->_transientValues->includes($k)) {
            ...
            $message = "EDD\Vendor\Stripe Notice: Undefined property of {$class} instance: {$k}. "
        ...
        $class = static::class;
        Stripe::getLogger()->error("EDD\Vendor\Stripe Notice: Undefined property of {$class} instance: {$k}");
    ...
    /**
     * Returns a pretty JSON representation of the EDD\Vendor\Stripe object.
     *
    ...
    /**
     * @return null|ApiResponse The last response from the EDD\Vendor\Stripe API
     */
    ...
    /**
     * Sets the last response from the EDD\Vendor\Stripe API.
     *
