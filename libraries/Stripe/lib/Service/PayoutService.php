...
class PayoutService extends \EDD\Vendor\Stripe\Service\AbstractService
{
     ...
     * EDD\Vendor\Stripe has sent you. The payouts are returned in sorted order, with the most
     ...
     * href="#balance">EDD\Vendor\Stripe balance</a> must be able to cover the payout amount, or
     ...
     *
     * If you are creating a manual payout on a EDD\Vendor\Stripe account that uses multiple
     ...
     * either a payout creation request or the payout list, and EDD\Vendor\Stripe will return the
