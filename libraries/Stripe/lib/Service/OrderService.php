...
class OrderService extends \EDD\Vendor\Stripe\Service\AbstractService
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Order>
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Order
     */
     ...
     * either an order creation request or the order list, and EDD\Vendor\Stripe will return the
