 ...
 * @property null|string|\EDD\Vendor\Stripe\Charge $charge The ID of the payment used to pay for the order. Present if the order status is <code>paid</code>, <code>fulfilled</code>, or <code>refunded</code>.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\EDD\Vendor\Stripe\Customer $customer The customer used for the order.
 ...
 * @property \EDD\Vendor\Stripe\OrderItem[] $items List of items constituting the order. An order can have up to 25 items.
 ...
 * @property null|\EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\OrderReturn> $returns A list of returns that have taken place for this order.
 * @property null|string $selected_shipping_method The shipping method that is currently selected for this order, if any. If present, it is equal to one of the <code>id</code>s of shipping methods in the <code>shipping_methods</code> array. At order creation time, if there are multiple shipping methods, EDD\Vendor\Stripe will automatically selected the first method.
 * @property null|\EDD\Vendor\Stripe\StripeObject $shipping The shipping address for the order. Present if the order is for goods to be shipped.
 * @property null|\EDD\Vendor\Stripe\StripeObject[] $shipping_methods A list of supported shipping methods for this order. The desired shipping method can be specified either by updating the order, or when paying it.
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $status_transitions The timestamps at which the order status was updated.
 * @property null|int $updated Time at which the object was last updated. Measured in seconds since the Unix epoch.
 * @property string $upstream_id The user's order ID if it is different from the EDD\Vendor\Stripe order ID.
 */
class Order extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\OrderReturn the newly created return
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Order the paid order
     */
