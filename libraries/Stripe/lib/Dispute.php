 ...
 * @property string|\EDD\Vendor\Stripe\Charge $charge ID of the charge that was disputed.
 ...
 * @property bool $is_charge_refundable If true, it is still possible to refund the disputed payment. Once the payment has been fully refunded, no further funds will be withdrawn from your EDD\Vendor\Stripe account as a result of this dispute.
 ...
 * @property null|string|\EDD\Vendor\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that was disputed.
