 ...
 * @property null|string $api_version The EDD\Vendor\Stripe API version used to render <code>data</code>. <em>Note: This property is populated only for events on or after October 31, 2014</em>.
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $request Information on the API request that instigated the event.
