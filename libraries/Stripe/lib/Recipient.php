...
/**
 * With <code>Recipient</code> objects, you can transfer money from your EDD\Vendor\Stripe
 ...
 * EDD\Vendor\Stripe accounts that don't already use recipients can no longer begin doing so.
 * Please use <code>Account</code> objects instead.</strong>
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\EDD\Vendor\Stripe\BankAccount $active_account Hash describing the current account on the recipient, if there is one.
 * @property null|\EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Card> $cards
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string|\EDD\Vendor\Stripe\Card $default_card The default card to use for creating transfers to this recipient.
 ...
 * @property null|string|\EDD\Vendor\Stripe\Account $migrated_to The ID of the <a href="https://stripe.com/docs/connect/custom-accounts">Custom account</a> this recipient was migrated to. If set, the recipient can no longer be updated, nor can transfers be made to it: use the Custom account instead.
 * @property null|string $name Full, legal name of the recipient.
 * @property string|\EDD\Vendor\Stripe\Account $rolled_back_from
