 ...
 * @property null|string $unit_label A label that represents units of this product in EDD\Vendor\Stripe and on customers’ receipts and invoices. When set, this will be included in associated invoice line item descriptions.
...
class Product extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\SearchResult<Product> the product search results
     */
