 ...
 * @property \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\BitcoinTransaction> $transactions A list with one entry for each time that the customer sent bitcoin to the receiver. Hidden when viewing the receiver with a publishable key.
