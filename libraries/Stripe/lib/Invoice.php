 ...
 *
 * If your invoice is configured to be billed through automatic charges, EDD\Vendor\Stripe
 ...
 * automatic</a>, does not happen immediately as the invoice is created. EDD\Vendor\Stripe
 * waits until one hour after the last webhook was successfully sent (or the last
 * webhook timed out after failing). If you (and the platforms you may have
 * connected to) have no webhooks configured, EDD\Vendor\Stripe waits one hour after creation
 ...
 * settings</a>, EDD\Vendor\Stripe will email the invoice to your customer and await payment.
 * These emails can contain a link to a hosted page to pay the invoice.
 *
 * EDD\Vendor\Stripe applies any customer credit on the account before determining the amount
 ...
 * @property null|string|\EDD\Vendor\Stripe\StripeObject $application ID of the Connect Application that created the invoice.
 * @property null|int $application_fee_amount The fee in %s that will be applied to the invoice and transferred to the application owner's EDD\Vendor\Stripe account when the invoice is paid.
 ...
 * @property bool $auto_advance Controls whether EDD\Vendor\Stripe will perform <a href="https://stripe.com/docs/billing/invoices/workflow/#auto_advance">automatic collection</a> of the invoice. When <code>false</code>, the invoice's state will not automatically advance without an explicit action.
 ...
 * @property null|string|\EDD\Vendor\Stripe\Account|\EDD\Vendor\Stripe\AlipayAccount|\EDD\Vendor\Stripe\BankAccount|\EDD\Vendor\Stripe\BitcoinReceiver|\EDD\Vendor\Stripe\Card|\EDD\Vendor\Stripe\Source $default_source ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
 ...
 * @property null|(string|\EDD\Vendor\Stripe\Discount)[] $discounts The discounts applied to the invoice. Line item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 ...
 * @property null|\EDD\Vendor\Stripe\ErrorObject $last_finalization_error The error encountered during the previous attempt to finalize the invoice. This field is cleared when the invoice is successfully finalized.
 * @property \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\InvoiceLineItem> $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
 ...
 * @property \EDD\Vendor\Stripe\StripeObject $threshold_reason
...
class Invoice extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\InvoiceLineItem> the list of lines (InvoiceLineItem)
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\SearchResult<Invoice> the invoice search results
     */
