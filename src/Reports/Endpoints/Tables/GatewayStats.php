 ...
 * @since 3.5.1
 */
class GatewayStats extends Table {
	...
	protected function get_label(): string {
		return __( 'Gateway Stats', 'easy-digital-downloads' ) . ' &mdash; ' . $this->get_chart_label();
	}
	...
	protected function get_class_name(): string {
		return '\\EDD\\Reports\\Data\\Payment_Gateways\\Gateway_Stats';
	}
}
