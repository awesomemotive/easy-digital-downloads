module.exports = function(grunt) {
	...
	grunt.initConfig({
		pkg: grunt.file.readJSON('package.json'),
			...
			cssmin: {
				...
				target: {
					files: {
						'assets/css/chosen.min.css'            : 'assets/css/chosen.css',
						'assets/css/colorbox.min.css'          : 'assets/css/colorbox.css',
						'assets/css/edd-admin.min.css'         : 'assets/css/edd-admin.css',
						'assets/css/jquery-ui-classic.min.css' : 'assets/css/jquery-ui-classic.css',
						'assets/css/jquery-ui-fresh.min.css'   : 'assets/css/jquery-ui-fresh.css',
					}
				}
			},
	...
	grunt.loadNpmTasks( 'grunt-contrib-cssmin' ); // minify various CSS assets
	grunt.loadNpmTasks( 'makepot' ); // update pot file

	// Default tasks for EDD project. - grunt default
