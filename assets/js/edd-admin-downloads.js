...
/*!******************************************************!*\
  !*** ./assets/js/admin/components/tooltips/index.js ***!
  \******************************************************/
/*! exports provided: tooltipArgs, edd_attach_tooltips */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tooltipArgs", function() { return tooltipArgs; });
...
var edd_attach_tooltips = function edd_attach_tooltips(selector, args) {
  return $(selector).tooltip(_babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0___default()({}, tooltipArgs, args));
};
...
/* harmony import */ var _prices_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./prices.js */ "./assets/js/admin/downloads/prices.js");
...
/***/ "./assets/js/admin/downloads/prices.js":
/*!*********************************************!*\
  !*** ./assets/js/admin/downloads/prices.js ***!
  \*********************************************/
/*! no exports provided */
...
document.addEventListener('DOMContentLoaded', function () {
  var inputs = document.querySelectorAll('.edd-price-field');
  ...
  _.each(inputs, function (input) {
    ...
    input.addEventListener('keyup', function (e) {
      ...
      newValue = currentValue.replace(edd_vars.thousands_separator, ''); // We will have to change something, make note of this.

      if (currentValue !== newValue) {
        needsFormatting = true; // Show tooltip...
      }
    });
    /**
    ...
    input.addEventListener('change', function (e) {
      ...
      if (needsFormatting) {// Hide tooltip...
      }
    });
  });
});
