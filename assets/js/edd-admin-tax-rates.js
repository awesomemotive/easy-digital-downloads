...
var RegionField = wp.Backbone.View.extend({
  ...
  render: function render() {
    ...
    if ('nostates' === this.states) {
      ...
      this.$el.find('select').chosen(utils_chosen_js__WEBPACK_IMPORTED_MODULE_0__["chosenVars"]);
    }
  }
});
...
var TableAdd = wp.Backbone.View.extend({
  ...
  render: function render() {
    ...
    this.$el.find('select').chosen(utils_chosen_js__WEBPACK_IMPORTED_MODULE_2__["chosenVars"]);
  },
