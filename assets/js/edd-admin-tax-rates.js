...
/* harmony import */ var _models_tax_rate_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../models/tax-rate.js */ "./assets/js/admin/settings/tax-rates/models/tax-rate.js");
/* harmony import */ var _views_region_field_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../views/region-field.js */ "./assets/js/admin/settings/tax-rates/views/region-field.js");
...
var TableAdd = wp.Backbone.View.extend({
   ...
   */
  initialize: function initialize() {
    this.model = new _models_tax_rate_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
      global: true,
      unsaved: true
    });
  ...
  render: function render() {
    ...
    this.$el.find('select').each(function () {
      var el = $(this);
      el.chosen(Object(utils_chosen_js__WEBPACK_IMPORTED_MODULE_4__["getChosenVars"])(el));
    });
  },
  ...
  updateRegion: function updateRegion() {
    ...
    $.post(ajaxurl, data, function (response) {
      self.views.set('#tax_rate_region_wrapper', new _views_region_field_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
        states: response,
  ...
  addTaxRate: function addTaxRate(event) {
    ...
    event.preventDefault();
    var existingCountryWide = this.collection.filter(function (rate) {
      return '' === _this.model.get('region') && _this.model.get('country') === rate.get('country') && true === rate.get('global') && 'active' === rate.get('status');
    });
