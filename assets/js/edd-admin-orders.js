...
Object(utils_jquery_js__WEBPACK_IMPORTED_MODULE_5__["jQueryReady"])(function () {
  ...
  (function () {
    var numberColumns = document.querySelectorAll('#edd-payments-filter td.column-number');

    _.each(numberColumns, function (column) {
      var viewLink = column.querySelector('.row-title');
      ...
      column.addEventListener('click', function (e) {
        var tagName = e.target.tagName; // Only continue through on the <td> or <strong> (status).
