...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.js */ "./assets/js/admin/orders/index.js");
...
(function () {
  ...
  $(document).on('edd-admin-add-order-download', function () {
    ...
    document.querySelectorAll('.overridable input').forEach(function (el) {
      return el.addEventListener('keyup', _index_js__WEBPACK_IMPORTED_MODULE_1__["default"].update_totals);
    }); // Update on addition.

    return _index_js__WEBPACK_IMPORTED_MODULE_1__["default"].update_totals();
  });
  /**
   * Allow edits.
   */
