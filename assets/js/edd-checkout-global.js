...
window.recalculate_taxes = _utils_js__WEBPACK_IMPORTED_MODULE_2__["recalculateTaxes"];
...
window.EDD_Checkout = function ($) {
      ...
      success: function success(discount_response) {
        if (discount_response) {
          if (discount_response.msg == 'valid') {
            ...
            Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["recalculateTaxes"])();
  ...
  return {
    init: init,
    recalculate_taxes: _utils_js__WEBPACK_IMPORTED_MODULE_2__["recalculateTaxes"]
  };
