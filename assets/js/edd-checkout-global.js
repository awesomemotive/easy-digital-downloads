...
window.recalculate_taxes = _utils_js__WEBPACK_IMPORTED_MODULE_0__["recalculateTaxes"];
...
window.EDD_Checkout = function ($) {
      ...
      success: function success(discount_response) {
        if (discount_response) {
          if (discount_response.msg == 'valid') {
            ...
            Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["recalculateTaxes"])();
  ...
  return {
    init: init,
    recalculate_taxes: _utils_js__WEBPACK_IMPORTED_MODULE_0__["recalculateTaxes"]
  };
...
/******/ });
//# sourceMappingURL=edd-checkout-global.js.map