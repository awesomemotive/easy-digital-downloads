...
/* harmony import */ var core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _checkout_utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkout/utils.js */ "./assets/js/frontend/checkout/utils.js");
  ...
  function update_state_field() {
    ...
    if ('card_state' !== $this.attr('id') && null != state_inputs) {
      ...
      $.ajax({
        ...
        if (is_checkout) {
          Object(_checkout_utils_js__WEBPACK_IMPORTED_MODULE_1__["recalculateTaxes"])();
        }
      });
    } else if (is_checkout) {
      Object(_checkout_utils_js__WEBPACK_IMPORTED_MODULE_1__["recalculateTaxes"])();
