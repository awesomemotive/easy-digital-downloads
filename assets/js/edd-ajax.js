...
/* harmony import */ var _edd_checkout_global_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edd-checkout-global.js */ "./assets/js/frontend/edd-checkout-global.js");
  ...
  function update_state_field() {
    ...
    if ('card_state' !== $this.attr('id')) {
      ...
      $.ajax({
        ...
        if (is_checkout) {
          Object(_edd_checkout_global_js__WEBPACK_IMPORTED_MODULE_1__["recalculate_taxes"])();
        }
      });
    } else if (is_checkout) {
      Object(_edd_checkout_global_js__WEBPACK_IMPORTED_MODULE_1__["recalculate_taxes"])();
