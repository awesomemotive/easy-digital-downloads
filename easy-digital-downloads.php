...
final class Easy_Digital_Downloads {
	...
	private function includes() {
		...
		require_once EDD_PLUGIN_DIR . 'includes/database/class-edd-db-table-api-request-logs.php';
		...
		require_once EDD_PLUGIN_DIR . 'includes/database/class-edd-db-table-file-download-logs.php';
