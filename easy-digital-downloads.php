...
final class Easy_Digital_Downloads {
	...
	private function includes() {
		...
		require_once EDD_PLUGIN_DIR . 'includes/database/class-edd-db-table-logs-api-requests.php';
		require_once EDD_PLUGIN_DIR . 'includes/database/class-edd-db-table-logs-file-downloads.php';
		...
		require_once EDD_PLUGIN_DIR . 'includes/class-edd-db-logs-api-requests.php';
		require_once EDD_PLUGIN_DIR . 'includes/class-edd-db-logs-file-downloads.php';
