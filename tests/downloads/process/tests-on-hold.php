...
/**
 * Download Process Tests for on hold orders
 *
 * Tests for file downloads and downloading permissions for on hold orders.
 *
 * @group edd_downloads
 */
class On_Hold extends Helpers\Process_Download {
	...
	public static function setUpBeforeClass(): void {
		...
		edd_update_order_status( self::$order->id, 'on_hold' );
	}
	...
	/**
	 * Test that an on hold order cannot download the file.
	 */
	...
	/**
	 * Test that an on hold order cannot download the file with a price ID.
	 */
	...
	/**
	 * Test that an on hold order cannot download the file with a different Price ID than purchased.
	 */
