...
/**
 * Download Process Tests for revoked orders
 *
 * Tests for file downloads and downloading permissions for revoked orders.
 *
 * @group edd_downloads
 */
class Revoked extends Helpers\Process_Download {
	...
	public static function setUpBeforeClass(): void {
		...
		edd_update_order_status( self::$order->id, 'revoked' );
	}
