...
class AdminOrderRefund extends EDD_UnitTestCase {
	 ...
	 * @var string
	 */
	private static $id = 'admin_order_refund';
	...
	public function test_email_name_is_correct() {
		$this->assertEquals( 'Admin Refund Notification', self::$email->get_name() );
	}
	...
	public function test_email_subject() {
		$this->assertEquals( 'An order has been refunded', self::$email->subject );
	}
