...
class NewUser extends EDD_UnitTestCase {
	...
	public function test_email_name_is_correct() {
		$this->assertEquals( 'New User Registration', self::$email->get_name() );
	}
	...
	public function test_email_subject() {
		$this->assertEquals( '[{sitename}] Your username and password', self::$email->subject );
	}

	public function test_email_heading() {
		$this->assertEquals( 'Your account info', self::$email->heading );
	}
