...
class Tests_Downloads extends WP_UnitTestCase {
	...
	public function test_price_range() {
		...
		$expected = '<span class="edd_price_range_low edd_price" id="edd_price_low_' . $this->_post->ID . '">&#36;20.00</span><span class="edd_price_range_sep">&nbsp;&ndash;&nbsp;</span><span class="edd_price_range_high edd_price" id="edd_price_high_' . $this->_post->ID . '>&#36;100.00</span>';
