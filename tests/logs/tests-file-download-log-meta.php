...
class File_Download_Log_Meta_Tests extends \EDD_UnitTestCase {
	...
	public function test_add_metadata_with_empty_value_should_be_empty() {
		$this->assertNotEmpty( edd_add_file_download_log_meta( self::$log->id, 'test_key', '' ) );
	}
	...
	public function test_add_metadata_with_key_value_should_not_be_empty() {
		$this->assertNotEmpty( edd_add_file_download_log_meta( self::$log->id, 'test_key', '1' ) );
	}
	...
	public function test_update_metadata_with_empty_key_value_should_be_empty() {
		$this->assertEmpty( edd_update_file_download_log_meta( self::$log->id, '', '' ) );
	}
	...
	public function test_update_metadata_with_empty_value_should_not_be_empty() {
		$this->assertNotEmpty( edd_update_file_download_log_meta( self::$log->id, 'test_key_2', '' ) );
	}
	...
	public function test_update_metadata_with_key_value_should_not_be_empty() {
		$this->assertNotEmpty( edd_update_file_download_log_meta( self::$log->id, 'test_key_2', '1' ) );
	}
	...
	public function test_get_metadata_with_no_args_should_be_empty() {
		$this->assertEmpty( edd_get_file_download_log_meta( self::$log->id ) );
	}
	...
	public function test_get_metadata_with_invalid_key_should_be_empty() {
		$this->assertEmpty( edd_get_file_download_log_meta( self::$log->id, 'key_that_does_not_exist', true ) );
	}
