...
class Tests_Taxes extends WP_UnitTestCase {
	...
	public function test_calculate_tax_price_includes_tax() {
		...
		// Prepare test
		global $edd_options;
		$origin_price_include_tax			= isset( $edd_options['prices_include_tax'] ) ? $edd_options['prices_include_tax'] : null;
		$edd_options['prices_include_tax'] 	= 'yes';
		...
		// Reset to origin
		$edd_options['prices_include_tax'] = $origin_price_include_tax;
	}
	...
	public function test_cart_needs_tax_address_fields_false() {
		...
		// Prepare test
		global $edd_options;
		$existing_enable_taxes = isset( $edd_options['enable_taxes'] ) ? $edd_options['enable_taxes'] : null;
		unset( $edd_options['enable_taxes'] );

		// Assert
		$this->assertFalse( edd_cart_needs_tax_address_fields() );

		// Reset to origin
		$edd_options['enable_taxes'] = $existing_enable_taxes;
	}
