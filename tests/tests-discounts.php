...
class Tests_Discounts extends EDD_UnitTestCase {
	...
	public function test_discount_start_date() {
		$this->assertSame( date( 'm/d/Y', time() ) . ' 00:00:00', edd_get_discount_start_date( $this->_post_id ) );
	}

	public function test_discount_expiration_date() {
		$this->assertSame( date( 'm/d/Y', time() ) . ' 23:59:59', edd_get_discount_expiration( $this->_post_id ) );
	}
