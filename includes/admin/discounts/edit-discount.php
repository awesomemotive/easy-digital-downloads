		...
		<table class="form-table">
			<tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input name="start_date" id="edd-start" type="text" value="<?php echo '0000-00-00 00:00:00' == $discount->start_date ? '' : esc_attr( $discount->start_date ); ?>" class="edd_datepicker" data-format="<?php echo edd_get_date_picker_format(); ?>" placeholder="<?php echo edd_get_date_picker_format(); ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input name="end_date" id="edd-expiration" type="text" value="<?php echo '0000-00-00 00:00:00' == $discount->end_date ? '' : esc_attr( $discount->end_date ); ?>"  class="edd_datepicker" data-format="<?php echo edd_get_date_picker_format(); ?>" placeholder="<?php echo edd_get_date_picker_format(); ?>" />
