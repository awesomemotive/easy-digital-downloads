...
function edd_downloads_contextual_help() {
	...
	$screen->set_help_sidebar(
		'<p><strong>' . sprintf(
			__( 'For more information:', 'easy-digital-downloads' ) . '</strong></p>' .
			'<p>' . sprintf( __( 'Visit the <a href="%s">documentation</a> on the Easy Digital Downloads website.', 'easy-digital-downloads' ), esc_url( 'http://docs.easydigitaldownloads.com/' ) )
		) . '</p>' .
		'<p>' . sprintf(
			__( '<a href="%1$s">Post an issue</a> on <a href="%2$s">GitHub</a>. View <a href="%3$s">extensions</a> or <a href="%4$s">themes</a>.', 'easy-digital-downloads' ),
	...
	$screen->add_help_tab(
		array(
			...
			'content' =>
				...
				'<p>' . sprintf( __( 'For more information, see <a href="%1$s">using Shortcodes</a> on the WordPress.org Codex or <a href="%2$s">Easy Digital Downloads Documentation</a>', 'easy-digital-downloads' ), 'https://codex.wordpress.org/Shortcode', 'http://docs.easydigitaldownloads.com/article/229-purchaselink' ) . '</p>',
		)
	);
