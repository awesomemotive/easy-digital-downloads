				...
				<?php else : ?>
					...
					<div class="edd_repeatable_product_wrapper edd_repeatable_row" data-key="1">
						<div class="edd-bundled-product-row<?php echo $variable_class; ?>">
							...
							<div class="edd-form-group edd-bundled-product-item">
								<?php /* translators: %s: Download singular label */ ?>
								<label class="edd-form-group__label edd-repeatable-row-setting-label" for="edd_bundled_products_1"><?php printf( esc_html_x( 'Select %s:', 'Noun: The singular label for the download post type', 'easy-digital-downloads' ), edd_get_label_singular() ); ?></label>
								<div class="edd-form-group__control">
								<?php
