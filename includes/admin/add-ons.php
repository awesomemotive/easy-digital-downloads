...
function edd_add_ons_page() {
	...
	<div class="wrap" id="edd-add-ons">
		...
		<h2>
			...
			<span>
				&nbsp;&nbsp;<a href="http://easydigitaldownloads.com/downloads/?utm_source=plugin-addons-page&utm_medium=plugin&utm_campaign=<?php echo $campaign; ?>&utm_content=All%20Extensions" class="button-primary" target="_blank"><?php _e( 'Browse All Integrations', 'easy-digital-downloads' ); ?></a>
			</span>
		</h2>
		...
		<div class="edd-add-ons-view-wrapper">
			<ul class="subsubsub">
				...
				foreach( $add_ons_tabs as $tab_id => $tab_name ) {
					...
					if ( 'all' === $tab_id ) {
						$tab_url = 'http://easydigitaldownloads.com/downloads/?utm_source=plugin-addons-page&utm_medium=plugin&utm_campaign=' . $campaign . '&utm_content=All%20Extensions';
					}
