...
function edd_add_options_link() {
	...
	$edd_tools_page         = add_submenu_page( 'edit.php?post_type=download', __( 'Easy Digital Download Tools', 'edd' ), __( 'Tools and Info', 'edd' ), 'install_plugins', 'edd-tools', 'edd_tools_page' );
