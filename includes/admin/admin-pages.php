...
function edd_add_options_link() {
	...
	$edd_settings_export    = add_management_page( __( 'EDD Settings Export / Import', 'edd' ), __( 'Export / Import EDD', 'edd' ), 'manage_shop_settings', 'edd-settings-export-import', 'edd_settings_export_import' );
