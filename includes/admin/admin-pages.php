...
function edd_add_options_link() {
	...
	$edd_tools_page         = add_submenu_page( 'edit.php?post_type=download', __( 'Easy Digital Download Info and Tools', 'edd' ), __( 'Info and Tools', 'edd' ), 'install_plugins', 'edd-tools', 'edd_tools_page' );
