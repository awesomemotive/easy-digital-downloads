	...
	public function admin_notice() {
		...
		if(
			...
			echo '<div class="updated"><p>';
				echo __( 'Allow Easy Digital Downloads to track plugin usage? Opt-in to tracking and our newsletter and immediately be emailed a 20% discount to the shop for <a href="https://easydigitaldownloads.com/extensions" target="_blank">Extensions</a>. No sensitive data is tracked.', 'edd' );
