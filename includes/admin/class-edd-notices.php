...
class EDD_Notices {
	 ...
	 * @since 3.0
	 */
	private function add_requirements_notices() {
		/**
		 * Notice for users running PHP < 5.6.
		 * @since 2.10
		 */
		if ( version_compare( PHP_VERSION, '5.6', '<' ) && ! get_user_meta( get_current_user_id(), '_edd_upgrade_php_56_dismissed', true ) ) {
