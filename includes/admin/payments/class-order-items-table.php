...
class EDD_Order_Item_Table extends WP_List_Table {
	 ...
	 * @since 3.0
	 *
	 * @param EDD_Discount $order_item Discount object.
	 ...
	 * @since 3.0
	 *
	 * @param EDD_Discount $order_item Data for the order_item code.
	 ...
	 * @access public
	 * @since 3.0
	 * @return array $order_item_codes_data Array of all the data for the order_item codes
	 */
	public function order_item_codes_data() {
	 ...
	 * @uses EDD_Order_Item_Table::order_item_codes_data()
	...
	public function prepare_items() {
		...
		$this->items = $this->order_item_codes_data();
