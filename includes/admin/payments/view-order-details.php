                                    ...
                                    <div class="edd-admin-box">
										...
										<?php if ( edd_use_taxes() ) : ?>
                                            <div class="edd-order-taxes edd-admin-box-inside">
                                                <p>
                                                    <span class="label"><?php _e( 'Tax', 'easy-digital-downloads' ); ?>
                                                        :</span>&nbsp;
                                                    <input name="edd-payment-tax" class="med-text" type="text"
                                                           value="<?php echo esc_attr( edd_format_amount( $order->get_tax() ) ); ?>"/>
                                                    <span class="edd-tax-rate"><?php echo $order->get_tax_rate() * 100; ?>
                                                        %</span>
                                                </p>
                                            </div>
										<?php endif; ?>
                                        ...
                                        <div class="edd-order-payment edd-admin-box-inside">
                                            <p>
                                                <span class="label"><?php _e( 'Total Price', 'easy-digital-downloads' ); ?>
                                                    :</span>&nbsp;
												<?php echo edd_currency_symbol( $payment->currency ); ?>&nbsp;<input
                                                        name="edd-payment-total" type="text" class="med-text"
                                                        value="<?php echo esc_attr( edd_format_amount( $payment->total ) ); ?>"/>
                                            </p>
                                        </div>

                                        <div class="edd-order-payment-recalc-totals edd-admin-box-inside"
                                             style="display:none">
                                            <p>
                                                <span class="label"><?php _e( 'Recalculate Totals', 'easy-digital-downloads' ); ?>
                                                    :</span>&nbsp;
                                                <a href="" id="edd-order-recalc-total"
                                                   class="button button-secondary right"><?php _e( 'Recalculate', 'easy-digital-downloads' ); ?></a>
                                            </p>
                                        </div>
                                ...
                                <div class="edd-order-update-box edd-admin-box">
                                    ...
                                    <div id="major-publishing-actions">
                                        ...
                                        <input type="submit" class="button button-primary right"
                                               value="<?php esc_attr_e( 'Save Payment', 'easy-digital-downloads' ); ?>"/>
                                        <div class="clear"></div>
                                    </div>
                                ...
                                <div id="edd-order-resend-receipt" class="postbox edd-order-data">
                                    <div class="inside">
                                        <div class="edd-order-resend-receipt-box edd-admin-box">
                                            ...
                                            <span alt="f223" class="edd-help-tip dashicons dashicons-editor-help"
                                                  title="<?php _e( '<strong>Resend Receipt</strong>: This will send a new copy of the purchase receipt to the customer&#8217;s email address. If download URLs are included in the receipt, new file download URLs will also be included with the receipt.', 'easy-digital-downloads' ); ?>"></span>
                                ...
                                <div class="inside">
                                    <div class="edd-admin-box">
                                        ...
                                        <div class="edd-unlimited-downloads edd-admin-box-inside">
                                            <p>
                                                <span class="label"><i data-code="f316"
                                                                       class="dashicons dashicons-download"></i></span>&nbsp;
                                                <input type="checkbox" name="edd-unlimited-downloads"
                                                       id="edd_unlimited_downloads"
                                                       value="1"<?php checked( true, $unlimited, true ); ?>/>
                                                <label class="description"
                                                       for="edd_unlimited_downloads"><?php _e( 'Unlimited file downloads', 'easy-digital-downloads' ); ?></label>
                                                <span alt="f223" class="edd-help-tip dashicons dashicons-editor-help"
                                                      title="<?php _e( '<strong>Unlimited file downloads</strong>: checking this box will override all other file download limits for this purchase, granting the customer unliimited downloads of all files included on the purchase.', 'easy-digital-downloads' ); ?>"></span>
                                            </p>
                                        </div>
                                ...
                                <div class="inside">
                                    <div class="edd-admin-box">
                                        <div class="edd-admin-box-inside">
                                            ...
                                            <p>
                                                <a href="<?php echo admin_url( 'edit.php?post_type=download&page=edd-tools&tab=logs&user=' . $user_id ); ?>"><?php _e( 'View customer download log', 'easy-digital-downloads' ); ?></a>
                                            </p>
                                            <p>
                                                <a href="<?php echo admin_url( 'edit.php?post_type=download&page=edd-payment-history&user=' . esc_attr( edd_get_payment_user_email( $order_id ) ) ); ?>"><?php _e( 'View all purchases of customer', 'easy-digital-downloads' ); ?></a>
                                            </p>
                                        </div>
                                        ...
                                        <div class="row">
                                            <ul class="edd-purchased-files-list-wrapper">
                                                ...
                                                <li class="download">
														...
														<?php else: ?>
                                                            <span class="deleted">
																<?php if ( ! empty( $cart_item['name'] ) ) : ?>
                                                                    ...
                                                                    <em>(<?php _e( 'Deleted', 'easy-digital-downloads' ); ?>
                                                                        )</em>
																<?php else: ?>
                                                    ...
                                                    <input type="hidden"
                                                           name="edd-payment-details-downloads[<?php echo $key; ?>][id]"
                                                           class="edd-payment-details-download-id"
                                                           value="<?php echo esc_attr( $item_id ); ?>"/>
                                                    <input type="hidden"
                                                           name="edd-payment-details-downloads[<?php echo $key; ?>][price_id]"
                                                           class="edd-payment-details-download-price-id"
                                                           value="<?php echo esc_attr( $price_id ); ?>"/>

													<?php if ( ! edd_item_quantities_enabled() ) : ?>
                                                        <input type="hidden"
                                                               name="edd-payment-details-downloads[<?php echo $key; ?>][quantity]"
                                                               class="edd-payment-details-download-quantity"
                                                               value="<?php echo esc_attr( $quantity ); ?>"/>
													<?php endif; ?>

													<?php if ( ! edd_use_taxes() ): ?>
                                                        <input type="hidden"
                                                               name="edd-payment-details-downloads[<?php echo $key; ?>][item_tax]"
                                                               class="edd-payment-details-download-item-tax"
													...
													<?php if ( ! empty( $cart_items[ $key ]['fees'] ) ) : ?>
                                                        ...
                                                        <input type="hidden"
                                                               name="edd-payment-details-downloads[<?php echo $key; ?>][fees]"
                                                               class="edd-payment-details-download-fees"
                                                ...
                                                <li class="item_price<?php echo $is_qty_enabled; ?>">
                                                    ...
                                                    <input type="text"
                                                           class="medium-text edd-price-field edd-payment-details-download-item-price edd-payment-item-input"
                                                           name="edd-payment-details-downloads[<?php echo $key; ?>][item_price]"
                                                           value="<?php echo edd_format_amount( $item_price ); ?>"/>
													<?php if ( edd_item_quantities_enabled() ) : ?>
                                                        &nbsp;&times;&nbsp;
                                                        <input type="number"
                                                               name="edd-payment-details-downloads[<?php echo $key; ?>][quantity]"
                                                               class="small-text edd-payment-details-download-quantity edd-payment-item-input"
												...
												<?php if ( edd_use_taxes() ) : ?>
													...
													<span class="edd-payment-details-label-mobile">
														...
														<?php echo edd_currency_symbol( $currency_code ); ?>
                                                        <input type="text"
                                                               class="small-text edd-price-field edd-payment-details-download-item-tax edd-payment-item-input"
                                                               name="edd-payment-details-downloads[<?php echo $key; ?>][item_tax]"
                                                               value="<?php echo edd_format_amount( $item_tax ); ?>"/>
                                                    </li>
												<?php endif; ?>
                                                ...
                                                <li class="price">
                                                    ...
                                                    <span class="edd-price-currency"><?php echo edd_currency_symbol( $currency_code ); ?></span><span
                                                            class="price-text edd-payment-details-download-amount"><?php echo edd_format_amount( $price ); ?></span>
                                                    <input type="hidden"
                                                           name="edd-payment-details-downloads[<?php echo $key; ?>][amount]"
                                                           class="edd-payment-details-download-amount"
                                                           value="<?php echo esc_attr( $price ); ?>"/>
                                                </li>
                                            </ul>

                                            <div class="edd-purchased-download-actions actions">
                                                <input type="hidden" class="edd-payment-details-download-has-log"
                                                       name="edd-payment-details-downloads[<?php echo $key; ?>][has_log]"
                                                       value="1"/>
												<?php if ( edd_get_download_files( $item_id, $price_id ) && edd_is_payment_complete( $order_id ) ) : ?>
                                                    <span class="edd-copy-download-link-wrapper">
														<a href="" class="edd-copy-download-link"
                                                           data-download-id="<?php echo esc_attr( $item_id ); ?>"
                                                           data-price-id="<?php echo esc_attr( $price_id ); ?>"><?php _e( 'Copy Download Link(s)', 'easy-digital-downloads' ); ?></a> |
													</span>
												<?php endif; ?>
                                                <a href="" class="edd-order-remove-download edd-delete"
                                                   data-key="<?php echo esc_attr( $key ); ?>"><?php _e( 'Remove', 'easy-digital-downloads' ); ?></a>
                                            </div>
                                        </div>
										<?php
										$i ++;
                                ...
                                <div class="edd-add-download-to-purchase inside">
                                    <ul>
                                        ...
                                        <li class="edd-add-download-to-purchase-actions actions">
                                            ...
                                            <a href="" id="edd-order-add-download"
                                               class="button button-secondary"><?php printf( __( 'Add New %s', 'easy-digital-downloads' ), edd_get_label_singular() ); ?></a>
                                        </li>

                                    </ul>

                                    <input type="hidden" name="edd-payment-downloads-changed"
                                           id="edd-payment-downloads-changed" value=""/>
                                    <input type="hidden" name="edd-payment-removed" id="edd-payment-removed"
                                           value="{}"/>

									<?php if ( ! edd_item_quantities_enabled() ) : ?>
                                        <input type="hidden" id="edd-order-download-quantity"
                                               name="edd-order-download-quantity" value="1"/>
									<?php endif; ?>

									<?php if ( ! edd_use_taxes() ) : ?>
                                        <input type="hidden" id="edd-order-download-tax" name="edd-order-download-tax"
                                               value="0"/>
									<?php endif; ?>
