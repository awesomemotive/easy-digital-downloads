...
function edd_payments_contextual_help() {
	...
	$screen->set_help_sidebar(
		...
		'<p>' . sprintf(
			...
			esc_url( 'https://easydigitaldownloads.com/pricnig/?utm_source=plugin-settings-page&utm_medium=contextual-help-sidebar&utm_term=pricing&utm_campaign=ContextualHelp' ),
		) . '</p>'
	);
