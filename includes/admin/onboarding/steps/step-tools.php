...
function step_html() {
	...
	<div class="edd-onboarding__get-suggestions-section">
		...
		<label class="checkbox-control checkbox-control--checkbox small-checkbox" for="get-suggestions-check">
			<input type="checkbox" id="get-suggestions-check" />
			<span>Help make EDD better for everyone (?)</span>
			<div class="checkbox-control__indicator"></div >>> CHANGE TO TOGGLE
		</label>
