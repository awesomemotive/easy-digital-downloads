	...
	<div class="metabox-holder" style="padding-top: 0;">
		<div class="postbox">
			...
			<div class="inside">
				...
				<p class="edd_graph_totals"><strong><?php printf( __( 'Average monthly earnings: %s', 'edd' ), edd_currency_filter( edd_get_average_monthly_download_earnings( $download_id ) ) ); ?>
