...
class EDD_Sales_Log_Table extends WP_List_Table {
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ){
			...
			case 'user_id' :
				return '<a href="' .
					admin_url( 'admin.php?page=edd-store&user=' . urlencode( $item['user_id'] ) ) .
					 '">' . $item[ 'user_name' ] . '</a>';
			...
			case 'payment_id' :
				return '<a href="' . admin_url( 'admin.php?page=edd-store&view=view-order-details&id=' . $item[ 'payment_id' ] ) . '">' . edd_get_payment_number( $item[ 'payment_id' ] ) . '</a>';
