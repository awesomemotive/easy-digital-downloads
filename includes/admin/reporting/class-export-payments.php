	...
	public function get_data() {
		...
		foreach ( $payments as $payment ) {
			...
			$data[] = array(
				...
				'amount'   => html_entity_decode( \EDD\Utils\Currency::display( $total, $currency_code ) ),
				'tax'      => html_entity_decode( \EDD\Utils\Currency::display( edd_get_payment_tax( $payment->ID, $payment_meta ), $currency_code ) ),
