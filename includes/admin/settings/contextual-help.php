...
function edd_settings_contextual_help() {
	...
	$screen->add_help_tab( array(
		...
		'content'	=>
			...
			'<p>' . __( 'A set of email tags has also been provided to allow the creation of personalized emails. A tag consists of a keyword surrounded by curly braces: <code>{tag}</code>.', 'easy-digital-downloads' ) . '</p>'
	) );
