...
function edd_settings_contextual_help() {
	...
	$screen->add_help_tab( array(
		...
		'content'	=>
			'<p>' . __( 'This screen provides the most basic settings for configuring your store. You can set the currency, page templates, and turn <em>Test Mode</em> on and off.', 'edd' ) . '</p>'
	) );
	...
	$screen->add_help_tab( array(
		...
		'title'	    => __( 'Styles', 'edd' ),
		'content'	=>
			'<p>' . __( 'This screen provides allows customization of your store&#39;s styles. For complete control, you can completely disable all styles generated by the plugin.', 'edd' ) . '</p>' 
	) );
	...
	$screen->add_help_tab( array(
		...
		'title'	    => __( 'Taxes', 'edd' ),
		'content'	=>
			'<p>' . __( 'This screen provides basic settings for adjusting how tax rules work for purchases.', 'edd' ) . '</p>' 
	) );
