...
function edd_settings_contextual_help() {
	...
	$screen->add_help_tab( array(
		...
		'content'	=> 
			...
			'<p>' . __( '<strong>Base State / Provice</strong>: This determines the state / province that is loaded by default on the checkout screen for customers that do not have an address stored in their account.', 'edd' ) . '</p>' .
