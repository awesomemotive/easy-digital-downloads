...
function edd_settings_contextual_help() {
	...
	$screen->add_help_tab( array(
		...
		'content'	=>
			...
			'<p>' . sprintf( __( 'A set of email tags has also been provided to allow the creation of personalized emails. A tag consists of a keyword surrounded by curly braces: %s. A description of each of these tags appears below the editor.', 'easy-digital-downloads' ), '<code>{tag}</code>' ) . '</p>'
	) );
