...
function edd_settings_contextual_help() {
	...
	$screen->add_help_tab( array(
		...
		'title'	    => __( 'Styles', 'edd' ),
		'content'	=> '<p>' . __( "This screen provides allows customization of your store's styles. For complete control, you can completely disable all styles generated by the plugin.", 'edd' ) . '</p>' 
	) );
