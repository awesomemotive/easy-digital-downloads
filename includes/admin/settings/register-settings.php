		...
		'general' => apply_filters( 'edd_settings_general',
			array(
				...
				'allow_tracking' => array(
					...
					'desc' => __( 'Allow Easy Digital Downloads to track plugin usage? Opt-in to tracking and our newsletter and immediately be emailed a 20% discount to the shop for <a href="https://easydigitaldownloads.com/extensions" target="_blank">Extensions and Themes</a>. No sensitive data is tracked.', 'edd' ),
					'type' => 'checkbox'
				),
