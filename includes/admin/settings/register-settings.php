		...
		'general' => apply_filters( 'edd_settings_general',
			array(
				...
				'test_payment_key' => array(
					...
					'desc' => sprintf( __( 'Acts as an override allowing you, or the EDD support staff, to run in test mode without affecting other users of your site. <a href="%s">Generate random key</a>', 'edd' ), wp_nonce_url( add_query_arg( array( 'edd-action' => 'generate_test_payment_key' ) ), 'edd_test_payment_key_nonce', 'edd_test_payment_key_nonce' ) ),
					'type' => 'text'
				),
				'purchase_page' => array(
					'id' => 'purchase_page',
