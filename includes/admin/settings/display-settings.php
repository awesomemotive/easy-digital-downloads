	...
	<div id="edd-header" class="edd-header">
		<div id="edd-header-wrapper">
			...
			<div id="edd-header-actions">
				<button id="edd-notification-button" class="edd-round" x-data @click="$store.eddNotifications.openPanel()">
					<span class="edd-round edd-number<?php echo ! $numberNotifications ? ' edd-hidden' : ''; ?>">
						<?php echo wp_kses( sprintf(
							/* Translators: %1$d number of notifications; %2$s opening span tag; %3$s closing span tag */
							__( '%1$d %2$sunread notifications%3$s', 'easy-digital-downloads' ),
							$numberNotifications,
