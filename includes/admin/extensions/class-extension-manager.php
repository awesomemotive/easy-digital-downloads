...
class Extension_Manager {
	...
	public function install() {
		...
		$required_pass = ! empty( $_GET['pass'] ) ? sanitize_text_field( $_GET['pass'] ) : '';
		$result        = array(
		...
		$plugin = ! empty( $_GET['plugin'] ) ? sanitize_text_field( $_GET['plugin'] ) : '';
		if ( empty( $plugin ) ) {
	...
	public function activate( $plugin_basename = '' ) {
		...
		if ( empty( $plugin_basename ) ) {
			$plugin_basename   = ! empty( $_GET['plugin'] ) ? sanitize_text_field( $_GET['plugin'] ) : '';
