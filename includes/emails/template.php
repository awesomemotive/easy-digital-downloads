...
function edd_default_email_template() {
	echo '<div style="width: 550px; border: 1px solid #ccc; background: #f0f0f0; padding: 12px; margin: 0 auto;">';
	echo '<div id="edd-email-content" style="background: #fff; border: 1px solid #ccc; padding: 15px;">';
