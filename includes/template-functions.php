		...
		<ul>
			...
			if ( $prices ) :
				...
				foreach ( $prices as $key => $price ) :
					...
					?><li id="edd_price_option_<?php echo $download_id . '_' . sanitize_key( $price['name'] ); ?>" <?php echo $schema; ?>>
						<label for="<?php echo esc_attr( 'edd_price_option_' . $download_id . '_' . $key ); ?>">
							<input type="<?php echo $type; ?>" <?php checked( apply_filters( 'edd_price_option_checked', $checked_key, $download_id, $key ), $key, false ); ?>
