...
/**
 * Add payment SVG definitions to the EDD checkout.
 * 
 * @since 2.9.x
 */
function edd_payment_svg_icons() {
	...
	<svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
		<defs>
		<?php if ( array_key_exists( 'mastercard', $payment_methods ) ) : ?>
		...
		<?php endif; ?>
		<?php if ( array_key_exists( 'americanexpress', $payment_methods ) ) : ?>
		...
		<?php endif; ?>
		<?php if ( array_key_exists( 'visa', $payment_methods ) ) : ?>
		...
		<?php endif; ?>	
		<?php if ( array_key_exists( 'discover', $payment_methods ) ) : ?>
		...
		<?php endif; ?>
		<?php if ( array_key_exists( 'paypal', $payment_methods ) ) : ?>
		...
		<?php endif; ?>	
		<?php if ( array_key_exists( 'amazon', $payment_methods ) ) : ?>	
