...
function edd_checkout_button_purchase() {
	...
	$complete_purchase =  isset( $edd_options['checkout_label'] ) && strlen( trim( $edd_options['checkout_label'] ) ) > 0 ? $edd_options['checkout_label'] : ( edd_get_cart_total() ? __( 'Purchase', 'edd' ) : __( 'Download', 'edd' ) );
	ob_start();
?>
