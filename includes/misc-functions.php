...
function edd_get_currencies() {
	$currencies = array(
		__( 'USD', 'edd' )  => __( 'US Dollars (&#36;)', 'edd' ),
		__( 'EUR', 'edd' )  => __( 'Euros (&euro;)', 'edd' ),
		__( 'GBP', 'edd' )  => __( 'Pounds Sterling (&pound;)', 'edd' ),
		__( 'AUD', 'edd' )  => __( 'Australian Dollars (&#36;)', 'edd' ),
		__( 'BRL', 'edd' )  => __( 'Brazilian Real (R&#36;)', 'edd' ),
		__( 'CAD', 'edd' )  => __( 'Canadian Dollars (&#36;)', 'edd' ),
		__( 'CZK', 'edd' )  => __( 'Czech Koruna', 'edd' ),
		__( 'DKK', 'edd' )  => __( 'Danish Krone', 'edd' ),
		__( 'HKD', 'edd' )  => __( 'Hong Kong Dollar (&#36;)', 'edd' ),
		__( 'HUF', 'edd' )  => __( 'Hungarian Forint', 'edd' ),
		__( 'ILS', 'edd' )  => __( 'Israeli Shekel (&#8362;)', 'edd' ),
		__( 'JPY', 'edd' )  => __( 'Japanese Yen (&yen;)', 'edd' ),
		__( 'MYR', 'edd' )  => __( 'Malaysian Ringgits', 'edd' ),
		__( 'MXN', 'edd' )  => __( 'Mexican Peso (&#36;)', 'edd' ),
		__( 'NZD', 'edd' )  => __( 'New Zealand Dollar (&#36;)', 'edd' ),
		__( 'NOK', 'edd' )  => __( 'Norwegian Krone', 'edd' ),
		__( 'PHP', 'edd' )  => __( 'Philippine Pesos', 'edd' ),
		__( 'PLN', 'edd' )  => __( 'Polish Zloty', 'edd' ),
		__( 'SGD', 'edd' )  => __( 'Singapore Dollar (&#36;)', 'edd' ),
		__( 'SEK', 'edd' )  => __( 'Swedish Krona', 'edd' ),
		__( 'CHF', 'edd' )  => __( 'Swiss Franc', 'edd' ),
		__( 'TWD', 'edd' )  => __( 'Taiwan New Dollars', 'edd' ),
		__( 'THB', 'edd' )  => __( 'Thai Baht (&#3647;)', 'edd' ),
		__( 'INR', 'edd' )  => __( 'Indian Rupee (&#8377;)', 'edd' ),
		__( 'TRY', 'edd' )  => __( 'Turkish Lira (&#8378;)', 'edd' ),
		__( 'RIAL', 'edd' ) => __( 'Iranian Rial (&#65020;)', 'edd' ),
		__( 'RUB', 'edd' )  => __( 'Russian Rubles', 'edd' )
	);
