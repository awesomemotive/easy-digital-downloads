...
function edd_add_file_download_log_meta( $file_download_log_id, $meta_key, $meta_value, $unique = false ) {
	return add_metadata( 'edd_file_download_log', $file_download_log_id, $meta_key, $meta_value, $unique );
}
...
function edd_delete_file_download_log_meta( $file_download_log_id, $meta_key, $meta_value = '' ) {
	return delete_metadata( 'edd_file_download_log', $file_download_log_id, $meta_key, $meta_value );
}
...
function edd_get_file_download_log_meta( $file_download_log_id, $key = '', $single = false ) {
	return get_metadata( 'edd_file_download_log', $file_download_log_id, $key, $single );
}
...
function edd_update_file_download_log_meta( $file_download_log_id, $meta_key, $meta_value, $prev_value = '' ) {
	return update_metadata( 'edd_file_download_log', $file_download_log_id, $meta_key, $meta_value, $prev_value );
}
...
function edd_delete_file_download_log_meta_by_key( $meta_key ) {
	return delete_metadata( 'edd_file_download_log', null, $meta_key, '', true );
}
