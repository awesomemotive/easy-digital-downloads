 ...
 * @since 3.0.0
 *
 * @see EDD_Note_Query::__construct() for accepted arguments.
 */
class EDD_Note_Query extends EDD_DB_Query {
	 ...
	 *                                              Default 'id'.
	 *     @type string       $               How to retrieved orders. Accepts 'ASC', 'DESC'. Default 'ASC'.
