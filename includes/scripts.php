...
function edd_load_admin_scripts( $hook ) {
	...
	wp_localize_script( 'edd-admin-scripts', 'edd_vars', array(
		...
		'reset_stats_warn'        => __( 'Are you sure you want reset your store? This process is <strong><em>not reversable</em></strong>. Please be sure you have a recent backup.', 'edd' ),
	));
