...
function edd_register_admin_styles() {
	...
	wp_register_style( 'jquery-ui-css',         $css_dir . 'jquery-ui-'           . $css_suffix, array(), $version );
	wp_register_style( 'jquery-ui-fresh',       $css_dir . 'jquery-ui-fresh'      . $css_suffix, array(), $version );
