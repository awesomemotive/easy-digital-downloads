		...
		<tbody>
			...
			<tr class="form-field">
				...
				<td>
					...
					<p class="description"><?php printf(__('Enter the start date for this discount code in the format of %s. For no start date, leave blank. If entered, the discount can only be used after or on this date.', 'edd'), get_option('date_format') ); ?></p>
				</td>
			</tr>
			<tr class="form-field">
				<th scope="row" valign="top">
				...
				<td>
					...
					<p class="description"><?php printf(__('Enter the expiration date for this discount code in the format of %s. For no expiration, leave blank', 'edd'), get_option('date_format') ); ?></p>
				</td>
			</tr>
			<tr class="form-field">
				<th scope="row" valign="top">
