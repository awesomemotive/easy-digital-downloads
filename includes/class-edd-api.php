		...
		switch( $process ) {
			case 'generate':
				if( $this->generate_api_key( $user_id ) ) {
					...
					wp_redirect( add_query_arg( 'edd-message', 'api-key-generated', 'admin.php?page=edd-tools&tab=api_keys' ) ); exit();
				} else {
					wp_redirect( add_query_arg( 'edd-message', 'api-key-exists', 'admin.php?page=edd-tools&tab=api_keys' ) ); exit();
				}
				break;
			case 'regenerate':
				$this->generate_api_key( $user_id, true );
				delete_transient( 'edd-total-api-keys' );
				wp_redirect( add_query_arg( 'edd-message', 'api-key-regenerated', 'admin.php?page=edd-tools&tab=api_keys' ) ); exit();
				break;
			case 'revoke':
				$this->revoke_api_key( $user_id );
				delete_transient( 'edd-total-api-keys' );
				wp_redirect( add_query_arg( 'edd-message', 'api-key-revoked', 'admin.php?page=edd-tools&tab=api_keys' ) ); exit();
				break;
			default;
				break;
		}
