...
<table id="edd_checkout_cart" <?php if ( ! edd_is_ajax_disabled() ) { echo 'class="ajaxed"'; } ?>>
	<thead>
		<tr class="edd_cart_header_row">
			...
			<th class="edd_cart_item_name"><?php echo apply_filters( 'edd_cart_table_item_name_label', __( 'Item Name', 'edd' ) ); ?></th>
			<th class="edd_cart_item_price"><?php echo apply_filters( 'edd_cart_table_item_price_label', __( 'Item Price', 'edd' ) ); ?></th>
			<th class="edd_cart_actions"><?php echo apply_filters( 'edd_cart_table_actions_label', __( 'Actions', 'edd' ) ); ?></th>
			...
			<?php foreach ( $cart_items as $key => $item ) : ?>
				<tr class="edd_cart_item" id="edd_cart_item_<?php echo esc_attr( $key ) . '_' . esc_attr( $item['id'] ); ?>" data-download-id="<?php echo esc_attr( $item['id'] ); ?>">
					...
					<td class="edd_cart_actions">
						...
						<?php endif; ?>
						<a class="edd_cart_remove_item_btn" href="<?php echo esc_url( edd_remove_item_url( $key ) ); ?>"><?php echo apply_filters( 'edd_cart_table_remove_item_link', __( 'Remove', 'edd' ) ); ?></a>
					</td>
				...
				<tr class="edd_cart_fee" id="edd_cart_fee_<?php echo $fee_id; ?>">
					...
					<td>
						<?php if( ! empty( $fee['type'] ) && 'item' == $fee['type'] ) : ?>
							<a href="<?php echo esc_url( edd_remove_cart_fee_url( $fee_id ) ); ?>"><?php echo apply_filters( 'edd_cart_table_remove_fee_link', __( 'Remove', 'edd' ) ); ?></a>
						<?php endif; ?>
					</td>
				</tr>
			<?php endforeach; ?>
