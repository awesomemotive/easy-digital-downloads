				...
				<tr class="edd_cart_item" id="edd_cart_item_<?php echo esc_attr( $key ) . '_' . esc_attr( $item['id'] ); ?>" data-download-id="<?php echo esc_attr( $item['id'] ); ?>">
					...
					<td class="edd_cart_actions">
						<?php if( edd_item_quanities_enabled() ) : ?>
							<input type="number" min="1" step="1" name="edd-quantity" class="edd-input edd-item-quantity" value="<?php echo edd_get_cart_item_quantity( $item['id'] ); ?>"/>
							<input type="hidden" name="edd-cart-key" value="<?php echo $key; ?>"/>
							<input type="hidden" name="edd-cart-download-id" value="<?php echo $item['id']; ?>"/>
						<?php endif; ?>
