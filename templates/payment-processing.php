<div id="edd-payment-processing">
	<p data-edd-loading="1"><?php printf( __( 'Your purchase is processing. This page will reload automatically in 8 seconds. If it does not, click <a href="%s">here</a>.', 'edd' ), edd_get_success_page_uri() ); ?>
