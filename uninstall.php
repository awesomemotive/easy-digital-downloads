...
function edd_uninstall() {
	...
	if ( is_multisite() ) {
		foreach ( $wpdb->get_col( "SELECT blog_id FROM {$wpdb->blogs}" ) as $blog_id ) {
			...
			/**
			 * Load `edd_settings` and update global variable for switched site.
			 *
			 * @pending  Generally, best way is probably below.
			 *
			 * Update global option variable at `switch_blog` action.
			 *
			 *	add_action( 'switch_blog', 'update_function_name', 10, 2 );
			 *
			 */
